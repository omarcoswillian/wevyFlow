...
(function() {
  ...
  function getComputedProps(el) {
    ...
    return {
      ...
      minWidth: el.style.minWidth || (cs.minWidth !== '0px' ? cs.minWidth : ''),
      minHeight: el.style.minHeight || (cs.minHeight !== '0px' ? cs.minHeight : ''),
      maxWidth: el.style.maxWidth || (cs.maxWidth !== 'none' ? cs.maxWidth : ''),
      maxHeight: el.style.maxHeight || (cs.maxHeight !== 'none' ? cs.maxHeight : ''),
      overflow: cs.overflow,
      position: el.style.position || cs.position,
      top: el.style.top || (cs.top !== 'auto' ? cs.top : ''),
      right: el.style.right || (cs.right !== 'auto' ? cs.right : ''),
      bottom: el.style.bottom || (cs.bottom !== 'auto' ? cs.bottom : ''),
      left: el.style.left || (cs.left !== 'auto' ? cs.left : ''),
      zIndex: el.style.zIndex || (cs.zIndex !== 'auto' ? cs.zIndex : ''),
      opacity: cs.opacity,
      boxShadow: el.style.boxShadow || (cs.boxShadow !== 'none' ? cs.boxShadow : ''),
      transform: el.style.transform || '',
      transition: el.style.transition || '',
      backdropFilter: el.style.backdropFilter || el.style.webkitBackdropFilter || '',
      mixBlendMode: cs.mixBlendMode !== 'normal' ? cs.mixBlendMode : 'normal',
